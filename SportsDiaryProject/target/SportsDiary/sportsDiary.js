...
function createAccount()
{
	...
	var dataCustomer = JSON.stringify({"firstName":document.getElementById('firstName').value,"lastName":document.getElementById('secondsName').value,"mobileNumber":document.getElementById('mobileNumber').value,"emailAddress":document.getElementById('emailAddress').value})
